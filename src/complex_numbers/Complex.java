...
public class Complex {
	...
	public void divideBy(double real, double imaginary) {
		...
		denominator.multiply(denominatorConjugate.getRealPart(), 
							 denominatorConjugate.getImaginaryPart());
	...
	public String toString() {
		return "Complex [realPart=" + realPart + ", imaginaryPart=" + imaginaryPart + "]("+realPart+" "+imaginaryPart+"i)";
	}
